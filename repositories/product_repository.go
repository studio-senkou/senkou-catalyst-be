...
func (r *productRepository) StoreProduct(product *models.Product) (*models.Product, error) {
...
func (r *productRepository) FindProductByID(productID string) (*models.Product, error) {
...
func (r *productRepository) FindProductsByMerchantID(merchantID string) ([]*models.Product, error) {
...
func (r *productRepository) FindMerchantByProductID(productID string) (*models.Merchant, error) {
